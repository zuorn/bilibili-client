function loadPageContent(page) {
  ...
  const actions = {
    ...
    popular: () => { pageStates.popular.pageNum = 1; pageStates.popular.hasMore = true; pageStates.popular.currentTab = 'comprehensive'; fetchPopularVideos('comprehensive', 1, false) },
